 ...
 * @extends cc.Scene
 */
cc.LoaderPLScene = cc.Scene.extend(/** @lends cc.LoaderScene# */{
    _logo: null,
    _logoTexture: null,
    _texture2d: null,
    _bgLayer: null,
    ...
    init:function(){
        ...
        this._label.setPosition(cc.p(100,150));
        this._bgLayer.addChild(this._label, 55);

        this._progressLoad = cc.Layer.create();
        this.addChild(this._progressLoad,50);
    ...
    _logoFadeIn: function () {
        ...
        var labelAction = cc.Sequence.create(
            ...
            cc.MoveTo.create(0.15,cc.p(100,140)));
    ...
    _updatePercent: function () {
        ...
        this._progressLoad.draw();
        this._progressLoad.draw = function(){
            var w = 250/100*percent;
            var pos = {x:w,y:120};
            cc.drawingUtil.setDrawColor4B(255,0,0,255);
            cc.drawingUtil.setLineWidth(25);
            cc.drawingUtil.drawLine(cc.p(50,120),cc.p(pos.x,pos.y));
        }
 ...
 */
cc.LoaderPLScene.preload = function (resources, selector, target) {
    if (!this._instance) {
        this._instance = new cc.LoaderPLScene();
        this._instance.init();
    }
